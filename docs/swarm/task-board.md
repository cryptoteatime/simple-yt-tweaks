...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `SYT-010A` | Audit and harden fixture coverage for #10/#8 risk | Reviewer | Needs Review | `swarm/syt-010a-test-harness-audit` | `tests/e2e/**`, docs as needed | parallel-safe after bootstrap | `SYT-CTL-001` | medium, fixture contracts | `docs/swarm/handoffs/SYT-010A.md` | #12 |
...
| --- | --- | --- | --- | --- |
| `SYT-010A` | `swarm/syt-010a-test-harness-audit` | Fixture determinism, #10 risk coverage, #8 remains gated, no runtime changes | targeted e2e review | `docs/swarm/handoffs/SYT-010A.md` |
