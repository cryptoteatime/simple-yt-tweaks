...
| --- | --- | --- | --- | --- | --- |
| `SYT-036` | `swarm/syt-036-home-hover-stuck-lifecycle` | #37 | Needs Review | Controller/Runner/Reviewer | Final failed-QA follow-up patch; validation, stricter live smoke, and exact Brave PWA verification passed locally. |
