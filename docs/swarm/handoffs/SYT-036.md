...
Push the final follow-up patch to draft PR #37, update the PR/issue notes with the new root cause and Brave PWA evidence, then route fresh review. After review passes, return to the human QA gate unless explicitly waived.
